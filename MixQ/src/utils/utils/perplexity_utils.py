...
class Perplexity:
    ...
    def _prepare_data(self):
        ...
        _dataset_path = self._dataset_path
        ...
        data = load_dataset(os.path.join(_dataset_path,"wikitext"), name='wikitext-2-raw-v1', 
                cache_dir="/cache", split=self._split)
    ...
    def calculate_perplexity(self, n_ctx=512, n_batch=512):
        ...
        tokens = self._tokenizer(self._text, truncation=False, return_tensors='pt').input_ids.to('cuda')
