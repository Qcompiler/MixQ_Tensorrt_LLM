...
size_t initMmaBase() {
    ...
    HGEMM_CHECK_CUDART_ERROR(
        cudaFuncSetAttribute(mmaBaseKernel, cudaFuncAttributeMaxDynamicSharedMemorySize, smem_max_size * 2));
...
torch::Tensor  MixAsyncStage4(
  ...
  //mmaAsyncStage4(mat1_ptr, mat2_ptr, input_ptr, m, n, k);
  //wmmaAsyncStage3(mat1_ptr, mat2_ptr, input_ptr, m, n, k);
  mmaBase(mat1_ptr, mat2_ptr, input_ptr, m, n, k);
  return input;
}
