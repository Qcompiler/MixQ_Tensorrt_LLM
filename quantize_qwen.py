...
def args_to_quant_config(args: argparse.Namespace) -> QuantConfig:
    ...
    if args.mix == "int8_mix":
        quant_config.quant_algo = QuantAlgo.int8_mix
    if args.mix == "int4_mix":
        quant_config.quant_algo = QuantAlgo.int4_mix
...
def convert_and_save_hf(args):
    ...
    if args.smoothquant is not None or args.int8_kv_cache or len(args.mix):
        mapping = Mapping(
