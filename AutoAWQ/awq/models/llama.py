...
class LlamaAWQForCausalLM(BaseAWQForCausalLM):
    ...
    @staticmethod
    def fuse_layers(model: LlamaForCausalLM, quant_config: Dict, mix = False):
...
from awq.modules.fused.mlp import QuantLlamaMLP,MixLlamaMLP
from awq.modules.fused.attn import QuantAttentionFused
from awq.modules.fused.norm import FasterTransformerRMSNorm
from awq.modules.linear import WQLinear_GEMM, WQLinear_GEMV,MixLinear_GEMM
...
class LlamaFuser:
    ...
    def _fuse_qkv(self, module: LlamaAttention):
        ...
        if isinstance(q_proj, WQLinear_GEMV) or isinstance(q_proj, WQLinear_GEMM) or isinstance(q_proj, MixLinear_GEMM):
            pass
        else:
        ...
        if isinstance(qkv_layer, WQLinear_GEMV):
            ...
            qkv_layer.bias = bias
        elif isinstance(qkv_layer, WQLinear_GEMM):
        ...
        elif isinstance(qkv_layer, MixLinear_GEMM):
