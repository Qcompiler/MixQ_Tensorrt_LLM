...
sys.path.append("/home/chenyidong/quant/bitsandbytes/evalbitsand.py")
import awq
...
def run_round(model_path, quant_file, n_generate, input_ids, batch_size, safetensors, fp16='fp16'):
    if fp16 == 'mix':
