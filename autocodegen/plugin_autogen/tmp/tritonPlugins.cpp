...
#include "fused_attention_kernel/_generate_trt_plugin/plugin.h"
...
extern "C"
{
    bool initLibNvInferPlugins(void* logger, const char* libNamespace)
    {
            ...
            nvinfer1::initializeTritonPlugin<nvinfer1::plugin::fused_attention_kernelPluginCreator>(logger, libNamespace);
